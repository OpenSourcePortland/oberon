...
describe Quartermaster do
  ...
  describe "for unsuccessful transactions" do 
    ...
    it "#transact should not increase shop buyer's ware of good if not enough goods to transact" do
      @shop.stock(@not_enough_of_good, 10, 50, 10)
    ...
    it "#transact should not decrease character seller's possession of good quantity if not enough goods to transact" do
      @shop.stock(@not_enough_of_good, 10, 50, 10)
