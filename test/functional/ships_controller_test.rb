...
class ShipsControllerTest < ActionController::TestCase
  ...
  test "should create ship" do
    assert_difference('Ship.count') do
      post :create, ship: { character_id: @ship.character_id, name: @ship.name, price: @ship.price, ship_type: @ship.ship_type, size: @ship.size }
    end
  ...
  test "should update ship" do
    put :update, id: @ship, ship: { character_id: @ship.character_id, name: @ship.name, price: @ship.price, ship_type: @ship.ship_type, size: @ship.size }
    assert_redirected_to ship_path(assigns(:ship))
  end
